...
export const metadata: Metadata = {
  ...
  description: 'Kenya\'s premier specialty coffee roastery. Traceable single origin arabica sourced across Kenya, SCA-graded and roasted fresh in Nairobi. Buy whole bean or ground coffee online — Classic and Premium grades. Free delivery across Nairobi.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Kenya\'s premier specialty coffee roastery. Traceable single origin arabica sourced across Kenya, roasted fresh in Nairobi. Buy online, free delivery across Nairobi.',
